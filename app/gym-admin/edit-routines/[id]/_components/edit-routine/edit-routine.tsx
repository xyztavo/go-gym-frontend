      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(OnSubmit)} className="space-y-8">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="ABC Routine" {...field} />
                </FormControl>
                <FormDescription>The routine name</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="this routine contains push pull legs.." {...field} />
                </FormControl>
                <FormDescription>The routine description</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Routine Image Url</FormLabel>
                <FormControl>
                  <Input
                ...
                <FormDescription>
                  The routine image (if possible a square one)
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
